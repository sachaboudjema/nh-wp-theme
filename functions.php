<?php
/**
 * networkhiker functions and definitions
 *
...
if ( ! function_exists( 'nh_setup' ) ) :
	...
	function nh_setup() {
		 ...
		 * If you're building a theme based on networkhiker, use a find and replace
		 * to change 'nh' to the name of your theme in all the template files.
		 */
 ...
 */
function nh_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'nh_content_width', 640 );
}
add_action( 'after_setup_theme', 'nh_content_width', 0 );
 ...
 */
function nh_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'nh' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'nh' ),
...
add_action( 'widgets_init', 'nh_widgets_init' );
